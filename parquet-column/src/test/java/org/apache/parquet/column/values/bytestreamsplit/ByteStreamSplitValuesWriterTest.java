...
public class ByteStreamSplitValuesWriterTest {
  ...
  public static class FloatTest {
    ...
    public void TestSingleElement() throws Exception {
      ...
      ByteStreamSplitValuesWriter.FloatByteStreamSplitValuesWriter writer = getWriter(1);
    ...
    public void TestSmallBuffer() throws Exception {
      ByteStreamSplitValuesWriter.FloatByteStreamSplitValuesWriter writer = getWriter(3);
  ...
  public static class DoubleTest {
    ...
    public void TestSingleElement() throws Exception {
      ...
      ByteStreamSplitValuesWriter.DoubleByteStreamSplitValuesWriter writer = getWriter(1);
    ...
    @Test
    public void TestSmallBuffer() throws Exception {
      ByteStreamSplitValuesWriter.DoubleByteStreamSplitValuesWriter writer = getWriter(3);
